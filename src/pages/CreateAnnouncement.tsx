...
const CreateAnnouncement = () => {
  ...
  return (
    <DynamicBackground className="min-h-screen">
      ...
      <div className={`pt-16 ${isMobile ? 'pb-40' : 'pb-20'} px-4 md:max-w-4xl md:mx-auto`}>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="h-full">
            ...
            <div className={`fixed bottom-0 left-0 right-0 p-4 bg-white/95 backdrop-blur-md border-t border-gray-200 ${isMobile ? 'z-[60]' : 'z-10'} shadow-lg`}>
              <StepNavigation 
                currentStep={currentStepIndex} 
                totalSteps={stepConfigs.length} 
