...
const OBFUSCATED_SUPABASE_KEY = "";
...
export const supabase = createClient<Database>(getSupabaseUrl(), getSupabaseKey(), {
  auth: {
    ...
    persistSession: true,
    storage: sessionStorage // Utilise sessionStorage au lieu de localStorage pour plus de sécurité
  }
});
