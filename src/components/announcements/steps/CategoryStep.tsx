...
const CategoryStep = ({ form, isMobile }: CategoryStepProps) => {
  ...
  return (
    <div className="space-y-6">
      <div className="mb-6">
        <h2 className="text-2xl font-semibold mb-2">Dans quelle page souhaitez-vous faire apparaître votre annonce ?</h2>
        <p className="text-muted-foreground">
          Choisissez la catégorie qui correspond le mieux à votre annonce pour améliorer sa visibilité.
        </p>
      </div>
            ...
            render={({ field }) => (
              <FormItem className="mb-0">
                ...
                <FormDescription className="mt-0 mb-3">
                  Sélectionnez la catégorie dans laquelle vous souhaitez publier votre annonce
                </FormDescription>
                <Select
